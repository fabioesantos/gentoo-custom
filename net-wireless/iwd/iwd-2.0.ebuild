...
if [[ ${PV} == *9999* ]]; then
	...
	IWD_EGIT_REPO_URI="https://github.com/illiliti/eiwd.git"
	ELL_EGIT_REPO_URI="https://git.kernel.org/pub/scm/libs/ell/ell.git"
else
	SRC_URI="https://github.com/illiliti/eiwd/releases/download/${PV}-1/iwd-${PV}.tar.xz"
...
LICENSE="GPL-2"
SLOT="0"
IUSE="+client cpu_flags_x86_aes cpu_flags_x86_ssse3 +crda dbus +monitor ofono standalone systemd wired"
